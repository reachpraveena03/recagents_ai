...
def schedule_interview(scheduler: Agent, candidate_email: str, email_agent: Agent, role: str) -> None:
    ...
    try:
        ...
        tomorrow_est = current_time_est + timedelta(days=1)
        interview_time = tomorrow_est.replace(hour=11, minute=0, second=0, microsecond=0)
        ...
        meeting_response = scheduler.run(
            ...
            Important Notes:
            - The meeting must be between 9 AM - 5 PM EST
            - Use EST (UTC-5) timezone for all communications
